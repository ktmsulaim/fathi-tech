...
<!-- Mirrored from demo.tempload.com/alya/blue-features-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Feb 2021 09:36:42 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<aside class="default-aside">
							<div class="sidebar">
								<ul>
									<li class="active"><a href="#">Software Solutions</a></li>
