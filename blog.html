...
<!-- Mirrored from demo.tempload.com/alya/blue-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Feb 2021 09:36:41 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<a href="blue-index.html" class="logo">
							<img src="assets/images/logo-blue.png" alt="Alya"/>
						</a>
						<!-- ***** Logo End ***** -->
						...
						<ul class="header-buttons">
							<li><a class="btn-nav-line" href="#">Login</a></li>
							<li><a class="btn-nav-primary" href="#">Register</a></li>
						</ul>
						<!-- ***** Header Buttons End ***** -->
					</nav>
				</div>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="blog-post-thumb big">
										...
										<h3>
											<a href="blue-blog-single.html">Alya Expands the Leadership Team with David Lin, Controller</a>
										</h3>
										<div class="text">
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="blog-post-thumb">
										...
										<h3>
											<a href="blue-blog-single.html">Alya Partners with Velocloud to Deliver Managed SD-WAN</a>
										</h3>
										<div class="text">
	...
	<footer>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<p class="copyright">© 2019 Alya. All Rights Reserved.</p>
				</div>
			</div>
		</div>
	</footer>
