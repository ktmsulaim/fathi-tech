...
<head>
	...
	<title>Fathi-Tech Solutions | PVT LTD</title>
...
<body>
				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<a href="index.html" class="logo">
							<img src="assets/images/logo.png" height="50" alt="Alya"/>
						</a>
						<!-- ***** Logo End ***** -->
						...
						<!-- ***** Menu Start ***** -->
						<ul class="nav">
							<li class="active"><a href="index.html#welcome">Home</a></li>
						...
						<aside class="default-aside">
							<div class="sidebar">
								<ul>
									...
									<li><a href="professiona-courses.html">Professional Courses</a></li>
									<li class="active"><a href="#">Cloud Solutions</a></li>
									<li><a href="language-services.html">Language Services</a></li>
								</ul>
	...
	<footer>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<p class="copyright">© <span class="year">2020</span> Fathi-Tech Solutions. All Rights Reserved.</p>
				</div>
			</div>
		</div>
	</footer>
